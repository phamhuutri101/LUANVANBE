...
const ReviewRouter = require("../router/ReviewsProductRouter");
const PromoRouter = require("../router/PromoRouter");
const FavoriteRouter = require("../router/FavoriteRouter");
const SearchRouter = require("../router/SearchRouter");
const ShopRouter = require("../router/shopRouter");
const calculateRevenueRouter = require("../router/calculateRevenue");
...
router.use("/v1/reviewsProduct", ReviewRouter);
...
router.use("/v1/calculateRevenue", calculateRevenueRouter);
